...
import { changeRoute, searchPeople } from './reducers';

const logger = createLogger();
const rootReducer = combineReducers({ changeRoute, searchPeople });       //combine the reducers from the reducers file into one root reducer
